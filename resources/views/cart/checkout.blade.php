    ...
    <header class="banner">
        <div class="wrap">
            <div class="logo logo--left">
                <a href="{{ route('home') }}">
                    <img class="logo__image  logo__image--small " alt="{{$setting->company}}" src="{{ $setting->logo }}" />
                </a>
            </div>
        </div>
    </header>
        ...
        <button class="order-summary-toggle" data-toggle="#order-summary"
            ...
            <span class="wrap">
                <span class="order-summary-toggle__inner">
                    ...
                    <span class="order-summary-toggle__total-recap" data-tg-refresh="refreshDiscount"
        ...
        <div class="wrap">
            <main class="main">
                <header class="main__header">
                    <div class="logo logo--left">
                        <a href="/">
                            <img class="logo__image  logo__image--small " alt="Mew Mobile"
                                        ...
                                        <div class="fieldset">
                                            <div class="field ">
                                                <div class="field__input-wrapper">
                                                    <input name="billingEmail" type="text" class="field__input"
                                                        placeholder="Email">
                                                </div>
                                            </div>
                                            <div class="field">
                                            ...
                                            <div class="field ">
                                                <div class="field__input-wrapper">
                                                    <input name="billingAddress" type="text" class="field__input"
                                ...
                                <ul class="links">
                                    @foreach ($pageContent as $item)
                                        @if ($item->type == 'ho-tro-khanh-hang')
                                            <li>
                                                <a target="_blank" href="{{ route('pagecontent', ['slug' => $item->slug]) }}"
