...
Route::group(['namespace'=>'Client','middleware' => ['checkLanguage']], function(){
    ...
    Route::post('/cart/remove', 'CartController@remove')->name('remove.from.cart');
    Route::get('thanh-toan.html','CartController@checkout')->name('checkout');
    Route::post('thanhtoan','CartController@postBill')->name('postBill');
    ...
    Route::get('san-pham-sale.html','ProductController@flashSale')->name('flashSale');
    ...
    Route::get('/search-ajax', 'ProductController@searchAjax')->name('search.ajax');
    Route::get('/cart/count', 'CartController@getCartCount')->name('get.cart.count');
